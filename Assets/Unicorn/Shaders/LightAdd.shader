...
Shader "HZEffect/LightAdd" {
    Properties {
        _MainTex_Color ("BaseColor", Color) = (1,1,1,1)
        _Nei_Color ("InnerColor", Color) = (0.5,0.5,0.5,1)
        _Nei_Color_QiangDu ("InnerColor_Intensity", Range(0, 1)) = 0.5
        _LunKuo_QuanZhong ("WeightOutline", Range(0, 5)) = 2.5
        _Alpha_QuanZhong ("Alpha_Weight", Range(0, 8)) = 4
        _All_QuanZhong ("Overall_weight", Range(0, 10)) = 1
        _HunHeTex ("Cut", 2D) = "white" {}
        _XiaoRong ("XiaoRong", Range(1, 0)) = 1
        [MaterialToggle] _XRSwap ("InvertChannel", Float ) = 0.01
